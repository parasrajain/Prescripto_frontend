...
const Doctors = () => {
  ...
  return (
    <div>
      ...
      <div className=' w-full flex flex-col justify-between md:flex-row items-start gap-5 mt-5'>
        <button className={`py-1 px-3 border rounded text-sm transition-all sm:hidden ${showFilter ? 'bg-[#5f6FFF] text-white':''}` } onClick={()=>setShowFilters(prev => !prev)}>Filters</button>
