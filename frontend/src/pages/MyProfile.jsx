  ...
  return (
    <div className="max-w-lg flex flex-col gap-2 text-sm">
      ...
      <div className="mt-10">
        {
          isEdit
          ?<button className="border border-[#5f6FFF] px-8 py-2 rounded-full hover:text-white transition-all hover:bg-[#5f6FFF]" onClick={()=>setEdit(false)}>Save Information</button>
